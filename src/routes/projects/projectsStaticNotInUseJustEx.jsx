      ...
      <div className={style.projectCon}>
        ...
        <div className={style.cards}>
          ...
          <div className={style.containt}>
            ...
            />
            <p>
              This Project is made in JS and CSS which converts different
              unites.
            </p>
          ...
          <div className={style.containt}>
            ...
            />
            <p>
              Drumkit Project which is purely made with javaScript. It works
              very fine and is ready to use as tablets or mobile apps. Internal
              CSS applied.
            </p>
